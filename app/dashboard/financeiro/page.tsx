...
export default async function FinanceiroPage() {
  ...
  for (const r of clientesRows) {
    clientesMap.set(r.id as string, {
      id: r.id as string, razao_social: r.razao_social as string,
      nome_fantasia: (r.nome_fantasia as string) || null, cnpj: r.cnpj as string,
      endereco: (r.endereco as string) || null, cidade: (r.cidade as string) || null,
      estado: (r.estado as string) || null, cep: (r.cep as string) || null,
      telefone: (r.telefone as string) || null, email: (r.email as string) || null,
      contato_responsavel: (r.contato_responsavel as string) || null,
      observacoes: (r.observacoes as string) || null,
      ativo: (r.ativo as number) === 1, created_at: r.created_at as string,
      updated_at: r.updated_at as string, user_id: r.user_id as string,
    })
  }
