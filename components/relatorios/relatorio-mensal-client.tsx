  ...
  const handleExportExcel = useCallback(async () => {
    ...
    try {
      ...
      if (exportData.ordens?.length > 0) {
        const osHeaders = ['N. OS', 'Cliente', 'Tipo Servico', 'Descricao', 'Valor', 'Status', 'Data Execucao', 'Liquidado', 'Valor Pago', 'Data Liquidacao', 'Tecnico', 'Local']
        const osRows = exportData.ordens.map((o: any) => [
          ...
          formatDateBR(o.data_execucao), o.liquidado ? 'Sim' : 'Nao', o.valor_pago,
      ...
      if (exportData.lancamentos?.length > 0) {
        const lHeaders = ['Tipo', 'Descricao', 'Categoria', 'Valor', 'Data', 'Status', 'Forma Pgto', 'Origem']
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground text-balance">Relatorio Mensal</h1>
